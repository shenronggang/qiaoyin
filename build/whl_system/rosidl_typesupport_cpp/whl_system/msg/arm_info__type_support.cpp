...
static const _ArmInfo_type_support_symbol_names_t _ArmInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, whl_system, msg, ArmInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, whl_system, msg, ArmInfo)),
  }
};
...
{
  return &::whl_system::msg::rosidl_typesupport_cpp::ArmInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, whl_system, msg, ArmInfo)() {
  return get_message_type_support_handle<whl_system::msg::ArmInfo>();
}
