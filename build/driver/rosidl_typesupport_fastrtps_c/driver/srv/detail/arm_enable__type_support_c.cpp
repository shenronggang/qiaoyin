...
#include "driver/srv/detail/arm_enable__rosidl_typesupport_fastrtps_c.h"
...
using _ArmEnable_Request__ros_msg_type = driver__srv__ArmEnable_Request;
...
size_t get_serialized_size_driver__srv__ArmEnable_Request(
  const void * untyped_ros_message,
...
static uint32_t _ArmEnable_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_driver__srv__ArmEnable_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_driver
size_t max_serialized_size_driver__srv__ArmEnable_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = driver__srv__ArmEnable_Request;
    is_plain =
      (
...
static size_t _ArmEnable_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_driver__srv__ArmEnable_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmEnable_Request)() {
...
using _ArmEnable_Response__ros_msg_type = driver__srv__ArmEnable_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_driver
size_t get_serialized_size_driver__srv__ArmEnable_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArmEnable_Response__ros_msg_type * ros_message = static_cast<const _ArmEnable_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_driver__srv__ArmEnable_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_driver
size_t max_serialized_size_driver__srv__ArmEnable_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = driver__srv__ArmEnable_Response;
    is_plain =
      (
...
static size_t _ArmEnable_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_driver__srv__ArmEnable_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmEnable_Response)() {
...
// already included above
// #include "driver/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "driver/srv/arm_enable.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmEnable)() {
