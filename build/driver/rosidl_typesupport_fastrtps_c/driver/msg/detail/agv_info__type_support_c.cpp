...
#include "driver/msg/detail/agv_info__rosidl_typesupport_fastrtps_c.h"
...
using _AgvInfo__ros_msg_type = driver__msg__AgvInfo;
...
size_t get_serialized_size_driver__msg__AgvInfo(
  const void * untyped_ros_message,
...
static uint32_t _AgvInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_driver__msg__AgvInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_driver
size_t max_serialized_size_driver__msg__AgvInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = driver__msg__AgvInfo;
    is_plain =
      (
...
static size_t _AgvInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_driver__msg__AgvInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, msg, AgvInfo)() {
