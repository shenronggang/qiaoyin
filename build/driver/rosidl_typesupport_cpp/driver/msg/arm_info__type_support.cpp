...
static const _ArmInfo_type_support_symbol_names_t _ArmInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, driver, msg, ArmInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, driver, msg, ArmInfo)),
  }
};
...
{
  return &::driver::msg::rosidl_typesupport_cpp::ArmInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, driver, msg, ArmInfo)() {
  return get_message_type_support_handle<driver::msg::ArmInfo>();
}
