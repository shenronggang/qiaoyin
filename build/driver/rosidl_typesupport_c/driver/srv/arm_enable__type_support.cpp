...
static const _ArmEnable_Request_type_support_symbol_names_t _ArmEnable_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmEnable_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver, srv, ArmEnable_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, driver, srv, ArmEnable_Request)() {
  return &::driver::srv::rosidl_typesupport_c::ArmEnable_Request_message_type_support_handle;
}
...
static const _ArmEnable_Response_type_support_symbol_names_t _ArmEnable_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmEnable_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver, srv, ArmEnable_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, driver, srv, ArmEnable_Response)() {
  return &::driver::srv::rosidl_typesupport_c::ArmEnable_Response_message_type_support_handle;
}
...
static const _ArmEnable_type_support_symbol_names_t _ArmEnable_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmEnable)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver, srv, ArmEnable)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, driver, srv, ArmEnable)() {
  return &::driver::srv::rosidl_typesupport_c::ArmEnable_service_type_support_handle;
}
