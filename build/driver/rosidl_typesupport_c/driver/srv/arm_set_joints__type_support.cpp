...
static const _ArmSetJoints_Request_type_support_symbol_names_t _ArmSetJoints_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmSetJoints_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver, srv, ArmSetJoints_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, driver, srv, ArmSetJoints_Request)() {
  return &::driver::srv::rosidl_typesupport_c::ArmSetJoints_Request_message_type_support_handle;
}
...
static const _ArmSetJoints_Response_type_support_symbol_names_t _ArmSetJoints_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmSetJoints_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver, srv, ArmSetJoints_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, driver, srv, ArmSetJoints_Response)() {
  return &::driver::srv::rosidl_typesupport_c::ArmSetJoints_Response_message_type_support_handle;
}
...
static const _ArmSetJoints_type_support_symbol_names_t _ArmSetJoints_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmSetJoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver, srv, ArmSetJoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, driver, srv, ArmSetJoints)() {
  return &::driver::srv::rosidl_typesupport_c::ArmSetJoints_service_type_support_handle;
}
