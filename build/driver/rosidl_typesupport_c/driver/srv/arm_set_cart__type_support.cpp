...
static const _ArmSetCart_Request_type_support_symbol_names_t _ArmSetCart_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmSetCart_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver, srv, ArmSetCart_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, driver, srv, ArmSetCart_Request)() {
  return &::driver::srv::rosidl_typesupport_c::ArmSetCart_Request_message_type_support_handle;
}
...
static const _ArmSetCart_Response_type_support_symbol_names_t _ArmSetCart_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmSetCart_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver, srv, ArmSetCart_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, driver, srv, ArmSetCart_Response)() {
  return &::driver::srv::rosidl_typesupport_c::ArmSetCart_Response_message_type_support_handle;
}
...
static const _ArmSetCart_type_support_symbol_names_t _ArmSetCart_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver, srv, ArmSetCart)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver, srv, ArmSetCart)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, driver, srv, ArmSetCart)() {
  return &::driver::srv::rosidl_typesupport_c::ArmSetCart_service_type_support_handle;
}
