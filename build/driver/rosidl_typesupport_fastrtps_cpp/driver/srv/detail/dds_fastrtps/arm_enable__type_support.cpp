...
#include "driver/srv/detail/arm_enable__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = driver::srv::ArmEnable_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const driver::srv::ArmEnable_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<driver::srv::ArmEnable_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ArmEnable_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const driver::srv::ArmEnable_Request *>(
...
static size_t _ArmEnable_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ArmEnable_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ArmEnable_Request__callbacks = {
  "driver::srv",
  "ArmEnable_Request",
...
static rosidl_message_type_support_t _ArmEnable_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ArmEnable_Request__callbacks,
...
{
  return &driver::srv::typesupport_fastrtps_cpp::_ArmEnable_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = driver::srv::ArmEnable_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const driver::srv::ArmEnable_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<driver::srv::ArmEnable_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ArmEnable_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const driver::srv::ArmEnable_Response *>(
...
static size_t _ArmEnable_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ArmEnable_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ArmEnable_Response__callbacks = {
  "driver::srv",
  "ArmEnable_Response",
...
static rosidl_message_type_support_t _ArmEnable_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ArmEnable_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &driver::srv::typesupport_fastrtps_cpp::_ArmEnable_Response__handle;
}
...
static service_type_support_callbacks_t _ArmEnable__callbacks = {
  "driver::srv",
  "ArmEnable",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, driver, srv, ArmEnable_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, driver, srv, ArmEnable_Response)(),
...
static rosidl_service_type_support_t _ArmEnable__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ArmEnable__callbacks,
...
{
  return &driver::srv::typesupport_fastrtps_cpp::_ArmEnable__handle;
}
