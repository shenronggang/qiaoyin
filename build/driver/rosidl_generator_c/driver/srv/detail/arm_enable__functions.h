...
#ifndef DRIVER__SRV__DETAIL__ARM_ENABLE__FUNCTIONS_H_
#define DRIVER__SRV__DETAIL__ARM_ENABLE__FUNCTIONS_H_
 ...
 * calls
 * driver__srv__ArmEnable_Request__init().
...
/**
 * It calls
 * driver__srv__ArmEnable_Request__fini()
...
/// Check for srv/ArmEnable message equality.
/**
 ...
 * driver__srv__ArmEnable_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * driver__srv__ArmEnable_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ArmEnable message array equality.
/**
...
/// Copy an array of srv/ArmEnable messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * driver__srv__ArmEnable_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_driver
...
/**
 * It calls
 * driver__srv__ArmEnable_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_driver
...
/**
 * It allocates the memory for the array and calls
 * driver__srv__ArmEnable_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_driver
...
/**
 * It calls
 * driver__srv__ArmEnable_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DRIVER__SRV__DETAIL__ARM_ENABLE__FUNCTIONS_H_
