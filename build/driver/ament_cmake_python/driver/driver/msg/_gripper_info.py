...
class GripperInfo(metaclass=Metaclass_GripperInfo):
    ...
    _fields_and_field_types = {
        'left_gripper': 'boolean',
        'right_gripper': 'boolean',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.left_gripper = kwargs.get('left_gripper', bool())
        self.right_gripper = kwargs.get('right_gripper', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.left_gripper != other.left_gripper:
            return False
        if self.right_gripper != other.right_gripper:
            return False
        return True
    ...
    def left_gripper(self):
        """Message field 'left_gripper'."""
        return self._left_gripper

    @left_gripper.setter
    def left_gripper(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'left_gripper' field must be of type 'bool'"
        self._left_gripper = value

    @builtins.property
    def right_gripper(self):
        """Message field 'right_gripper'."""
        return self._right_gripper

    @right_gripper.setter
    def right_gripper(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'right_gripper' field must be of type 'bool'"
        self._right_gripper = value
