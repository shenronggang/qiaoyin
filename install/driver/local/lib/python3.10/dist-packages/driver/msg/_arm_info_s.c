...
bool driver__msg__arm_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("driver.msg._arm_info.ArmInfo", full_classname_dest, 28) == 0);
  }
  driver__msg__ArmInfo * ros_message = _ros_message;
  {  // left_arm_joints
...
{
  /* NOTE(esteve): Call constructor of ArmInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("driver.msg._arm_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmInfo");
