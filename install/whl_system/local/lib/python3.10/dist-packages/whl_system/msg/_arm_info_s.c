...
bool whl_system__msg__arm_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("whl_system.msg._arm_info.ArmInfo", full_classname_dest, 32) == 0);
  }
  whl_system__msg__ArmInfo * ros_message = _ros_message;
  {  // joints
  ...
  {  // arm_speed
    PyObject * field = PyObject_GetAttrString(_pymsg, "arm_speed");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 2;
      double * dest = ros_message->arm_speed;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
...
PyObject * whl_system__msg__arm_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("whl_system.msg._arm_info");
  ...
  {  // arm_speed
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "arm_speed");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 * dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double * src = &(ros_message->arm_speed[0]);
